                ...
                {filtered.map((tutor) => (
                  ...
                  >
                    ...
                    <div className="p-5 space-y-3">
                      <div>
                        <h3 className="font-semibold text-gray-900">{tutor.user?.name}</h3>
                        <p className="text-sm text-blue-600 font-medium">{tutor.location}</p>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                        <div>
                          <span className="text-lg font-bold text-gray-900">৳{tutor.hourlyRate}</span>
